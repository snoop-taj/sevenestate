...
class UploadHandler
{
    ...
    protected function create_scaled_image($file_name, $version, $options) {
        ...
        {            
            if($options['watermark'] == true && file_exists(FCPATH.'admin-assets/img/stamp.png') && $this->options['watermark_disabled'] === FALSE)
            {
                $stamp = imagecreatefrompng(FCPATH.'admin-assets/img/stamp.png');
