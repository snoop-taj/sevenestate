...
class User_m extends MY_Model {
    ...
    public $rules_admin = array(
        ...
        'password' => array('field'=>'password', 'label'=>'lang:Password', 'rules'=>'trim|matches[password_confirm]'),
        'password_confirm' => array('field'=>'password_confirm', 'label'=>'lang:PasswordConfirm', 'rules'=>'trim|matches[password]'),
	...
	public function __construct(){
        ...
        $this->user_types = array('ADMIN'=>lang('ADMIN'), 'AGENT'=>lang('AGENT'), 'USER'=>lang('USER'));
