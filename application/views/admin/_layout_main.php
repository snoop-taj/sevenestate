    ...
    <div class="sidebar">
        ...
        <div class="sidebar-inner">
          ...
          <ul class="navi">
            ...
            <li class="ngreen<?php echo (strpos($this->uri->uri_string(),'page')!==FALSE)?' current':'';?>"><a href="<?php echo site_url('admin/page')?>"><i class="icon-sitemap"></i> <?php echo lang('Pages & menu');?></a></li>
            <?php endif;?>
            ...
            <?php if(config_item('admin_beginner_enabled') === TRUE):?>
                <?php if(check_acl('user')):?>
                <li class="norange<?php echo (strpos($this->uri->uri_string(),'user')!==FALSE && strpos($this->uri->uri_string(),'user/edit/'.$this->session->userdata('id'))===FALSE)?' current':'';?>"><a href="<?php echo site_url('admin/user')?>"><i class="icon-list-alt"></i> <?php echo lang('Agents & Users');?></a></li>
                <?php endif;?>
                
                
                <?php if(check_acl('enquire')):?>
                <li class="nviolet<?php echo (strpos($this->uri->uri_string(),'enquire')!==FALSE)?' current':'';?>"><a href="<?php echo site_url('admin/enquire')?>"><i class="icon-envelope-alt"></i> <?php echo lang('Enquires');?></a></li>
                <?php endif;?>
                
                <li class="nblue<?php echo (strpos($this->uri->uri_string(),'user/edit/'.$this->session->userdata('id'))!==FALSE)?' current':'';?>"><a href="<?php echo site_url('admin/user/edit/'.$this->session->userdata('id'))?>"><i class="icon-user"></i> <?php echo lang('Profile');?></a></li>
                ...
                <?php if(check_acl('settings')):?>
                    <li class="has_submenu nred<?php echo (strpos($this->uri->uri_string(),'settings')!==FALSE)?' current open':'';?>">
                      ...
                      <ul>
                        <li><a href="<?php echo site_url('admin/settings')?>"><?php echo lang('Company details');?></a></li>
                        ...
                        <li><a href="<?php echo site_url('admin/settings/system')?>"><?php echo lang('System');?></a></li>
                      </ul>
                    </li>
                <?php endif;?>
            ...
            <li class="ngreen<?php echo (strpos($this->uri->uri_string(),'slideshow')!==FALSE)?' current':'';?>"><a href="<?php echo site_url('admin/slideshow')?>"><i class="icon-picture"></i> <?php echo lang('Slideshow')?></a></li>
            <li class="nlightblue<?php echo (strpos($this->uri->uri_string(),'statistics')!==FALSE)?' current':'';?>"><a target="_blank" href="https://www.google.com/analytics/web"><i class="icon-bar-chart"></i> <?php echo lang('Statistics');?></a></li>
            <?php endif;?>
            ...
            <li class="nblue<?php echo (strpos($this->uri->uri_string(),'reviews')!==FALSE)?' current open':'';?>">
                <a href="<?php echo site_url('admin/reviews')?>">
                    <!-- Menu name with icon -->
                    <i class="icon-star"></i> <?php echo lang_check('Reviews');?>
                </a>
            </li>
            <?php endif;?>
