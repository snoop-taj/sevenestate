                                  ...
                                  <div style="padding-top: 9px; border-bottom: 1px solid #ddd;" class="tab-content">
                                    ...
                                    <div id="<?php echo $key_lang?>" class="tab-pane <?php echo $i==1?'active':''?>">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                            <?php echo form_dropdown('currency_code_'.$key_lang, $currencies, set_value('currency_code_'.$key_lang, $rate->{'currency_code_'.$key_lang}), 'class="form-control" id="inputCurrencyCode'.$key_lang.'" placeholder="'.lang('Currency code').'"')?>
                                          </div>
                                        </div>
