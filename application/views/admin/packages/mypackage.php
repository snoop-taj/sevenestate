                    ...
                    <table class="table table-bordered ">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            if($listing->package_price > 0){
                                echo anchor('admin/packages/do_purchase_package/'.$listing->id.'/'.$listing->package_price, '<i class="icon-shopping-cart"></i> '.lang('Buy/Extend'), array('class'=>'btn btn-info'));
                            }
