...
<div class="form-horizontal">
    ...
    <div class="control-group warning">
        ...
        <div class="controls">
            <?php echo form_input('codecanyon_code', set_value('codecanyon_code', ''))?> <a target="_blank" href="http://support.envato.com/index.php?/Knowledgebase/Article/View/506/54/where-can-i-find-my-purchase-code"><?php echo lang_check('Where to find?')?></a>
        </div>
    </div>
