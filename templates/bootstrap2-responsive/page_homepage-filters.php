    ...
    <div class="results-properties-list with-sidebar">
        ...
        <div class="filter-checkbox-container">
            ...
            <div class="row">
                ...
                <div class="span12">
                    <input style="" option_id="36" type="text" rel="from" class="span12 input_am_from id_36_from" placeholder="{lang_Fromprice} ({options_prefix_36}{options_suffix_36})" />
                </div>
                <div class="span12">
                    <input style="" option_id="36" type="text" rel="to" class="span12 input_am_to id_36_to" placeholder="{lang_Toprice} ({options_prefix_36}{options_suffix_36})" />
                </div>
            </div>
